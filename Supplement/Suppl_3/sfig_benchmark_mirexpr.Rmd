...
**Restricting hypotheses to expressed miRNA systematically improves performance. A:** Rank of the true miRNA (left) and FDR (right) using all or only expressed miRNAs, with the two best-performing tests. **B:** Summary of the specificity/sensitivity of using all or only expressed miRNAs.
