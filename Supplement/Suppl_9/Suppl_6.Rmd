...
#plot
p1 <- ggplot(res, do.call(aes_string, ll)) + geom_point(alpha=opacity) + geom_text_repel(data=res[w,], show.legend = FALSE, point.padding = 7,max.overlaps = 20, min.segment.length = 0) + theme_classic() + ggtitle("RBPs potentially regulating synaptic genes in the hippocampus") + xlab("enrichment")
```
...
p1
#ggsave("Suppl_6.png",plot = p1, width = 10, height = 8,bg = "white")
```
