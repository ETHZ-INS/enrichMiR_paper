...
**CD plots supporting a potential role for miR-129-5p in PTX mediated homeostatic scaling in neurons. A** CD plot with the TargetScan rat conserved annotation, split by best site type. **B** CD plot split by score with the TargetScan rat conserved annotation. **C** CD plot split by score with the scanMiR rat annotation. **D-E** CD plots split in targets / non-targets with again the TargetScan rat conserved and the scanMiR rat annotations.
